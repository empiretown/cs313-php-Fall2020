...
require_once '../functions.php';
 ...
 switch ($action) {
     ...
     case 'registration':
        ...
        $hashPassword  = password_hash($clientPassword, PASSWORD_DEFAULT);
        $regOutcome = registerClient($clientUsername, $hashPassword);
        ...
        if ($regOutcome === 1)  {
            ...
            $_SESSION['message'] = "<p>Sorry $clientFullname, registration failed. Please try again.</p>";
            header("location: /view/registration.php");
            exit;
        }
    break;
